...
@EFragment(R.layout.fragment_wapres_candidate_profile)
public class WapresCandidateProfileFragment extends Fragment {
	...
	@ViewById(R.id.first_candidate_wapres)
	...
	public static WapresCandidateProfileFragment createFragment(
			List<HashMap<String, String>> id) {
		WapresCandidateProfileFragment fragment = new WapresCandidateProfileFragment_();
